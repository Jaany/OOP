...
<h2> View Seats</h2>
  ...
  <p><button class="button1"style="background-color:green;"></button>  Available </p>
  <br>
  ...
  <p><button class="button"style="background-color:gray;"></button>  Not Provided </p>  
    ...
    <p><input type="Button" name="back" id=back value="Back" onclick="document.location = 'BusDetails.jsp'"> </p>  
